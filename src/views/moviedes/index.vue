<template>
  <div>
    ...
    <div id="mine">
      ...
      <!-- 图片 -->
      <div class="big-img">
        <!-- <img  src="https://pic.maizuo.com/usr/movie/0b0a1bf167bac70d4955bf8caf89fbdc.jpg?x-oss-process=image/quality,Q_70"> -->
      ...
      <div class="goSchedule" @click="select()">选座购票</div>
    </div>
  </div>
</template>
