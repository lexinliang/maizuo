                ...
                <div>
                    <form>
                        <div class="form-group">
                            <input type="tel" maxlength="13" placeholder="手机号" class="input-control" v-model="text" @input="handelChange($event)">
                            <div style="display:none" ref="icon">
                                <div class="clear-mobile-btn" @click="handelClick()">
                                <i class="iconfont iconguanbi" style="position: absolute; right: .90rem; line-height: .40rem; font-size: .12rem; color: rgb(189, 192, 197);">
                                </i>
                            </div>
                        </div> 
                        <div class="getSmsCode sms-code disable" style="position: absolute; right: 0px; top: .13rem;">
                            获取验证码
                         </div>
                </div> 
                <div class="errorTip" style="display: block;" ref="err">
                </div> <!----> 
                <div class="errorTip" style="display: block;">
                </div> 
                <div class="form-group">
                    <input placeholder="验证码" class="input-control">
                    </div> <!----> <!---->
                     <div class="submit login-btn" @click="handelBtn()">
                    <span>登录</span>
                    </div>
                </form> <!---->
                </div>
...
.web-login .login-form .clear-mobile-btn, .web-login .login-form .eye {
    font-size: 13px;
    position: absolute;
    top: 8px;
    right: 0;
